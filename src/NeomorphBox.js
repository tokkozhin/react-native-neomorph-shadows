...
export default class NeomorphBox extends React.PureComponent {
  render() {
    const {
      style: {
        shadowOffset = null,
    ...
    let styleLight = {
      ...styleAll,
      shadowOffset: {
        width: -_shadowOffset.width,
        height: -_shadowOffset.height,
      },
    ...
    return inner ? (
      <View
        ...
        <InnerShadowBox
          style={swapShadowLevel ? styleLightShadowBox : styleDarkShadowBox}>
          <InnerShadowBox
            style={swapShadowLevel ? styleDarkShadowBox : styleLightShadowBox}
          />
        </InnerShadowBox>
        {children}
      </View>
